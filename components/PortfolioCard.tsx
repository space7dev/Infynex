      ...
      <div className="Infynex-portfolios-list-sec-wrap flex flex-col md:flex-row gap-6 bg-white rounded-lg shadow-lg overflow-hidden p-6 hover:shadow-xl transition">
        ...
        <div className="Infynex-new-portfolio-content flex-1">
          ...
          <div className="new-uae-port-app-details mb-4">
            ...
            <h4 className="suffesv3-main-heading text-3xl font-bold mt-2 text-gray-900">{title}</h4>
            <h5 className="suffesv3-sub-heading text-xl mt-1 text-gray-600">{subtitle}</h5>
          </div>

          {/* Description */}
          <p className="suffesv3-sub-para mt-3 text-xl text-gray-700 leading-relaxed">{description}</p>
              ...
              {ratings && (
                <li>
                  <div className="Infynex-app-stacks-wrap">
                    <h6 className="suffesv3-sub-heading font-bold text-lg">{ratings}</h6>
                    <p className="suffesv3-sub-para text-sm text-gray-600">Avg. Ratings</p>
                  </div>
                </li>
              )}
              {downloads && (
                <li>
                  <div className="Infynex-app-stacks-wrap">
                    <h6 className="suffesv3-sub-heading font-bold text-lg">{downloads}</h6>
                    <p className="suffesv3-sub-para text-sm text-gray-600">Downloads</p>
                  </div>
                </li>
              )}
            </ul>
          ...
          {technologies && technologies.length > 0 && (
            <div className="mt-6">
              <h6 className="suffesv3-sub-heading font-semibold mb-3 text-gray-900">Technology</h6>
              <ul className="Infynex-new-portfolio-tech-list flex flex-wrap gap-2">
                {technologies.map((tech, idx) => (
                  <li key={idx} className="bg-gray-100 rounded px-3 py-1">
                    <img
                      src={`https://www.Infynex.com/assets/img/portfolio/${tech.toLowerCase().replace(/[.\s]/g, '-')}-icon.webp`}
                      alt={tech}
